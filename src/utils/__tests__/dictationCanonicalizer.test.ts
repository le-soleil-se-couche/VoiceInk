...
const CASES: CanonCase[] = [
  ...
  { name: "十位小数点归一", input: "十一点二", expected: "11.2" },
  { name: "十位多位小数点归一", input: "十一点二十七", expected: "11.27" },
  { name: "多位小数点归一", input: "一二点三四", expected: "12.34" },
  { name: "版本十位小数归一", input: "版本十一点二", expected: "版本11.2" },
  ...
  { name: "名为字面保护-标点", input: "这个标点名为问号", expected: "这个标点名为问号" },
  { name: "名为字面保护-符号", input: "这个符号名为句号", expected: "这个符号名为句号" },
  { name: "称之为字面保护-标点", input: "这个标点称之为问号", expected: "这个标点称之为问号" },
  { name: "称之为字面保护-符号", input: "这个符号称之为句号", expected: "这个符号称之为句号" },
  { name: "对比并列标点词-还是-句号", input: "我们学习逗号还是句号", expected: "我们学习逗号还是句号" },
  { name: "对比并列标点词-还是-感叹号", input: "请区分问号还是感叹号", expected: "请区分问号还是感叹号" },
