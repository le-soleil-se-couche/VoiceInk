...
const CASES: CanonCase[] = [
  ...
  { name: "口语高位简写一万二归一", input: "预算一万二", expected: "预算12000" },
  { name: "口语高位简写一千二归一", input: "库存一千二", expected: "库存1200" },
  { name: "显式零高位表达保持精确", input: "预算一万零二", expected: "预算10002" },
  ...
  { name: "这是字面保护", input: "这是句号", expected: "这是句号" },
  { name: "它叫字面保护", input: "它叫问号", expected: "它叫问号" },
  { name: "我说的是字面保护", input: "我说的是分号", expected: "我说的是分号" },
