...
const ANSWER_LIKE_TRANSCRIPTION_PATTERNS = [
  ...
  /^\s*i(?:'m| am)\s+here\s+to\s+help(?:\s+you)?(?:\s+with\s+that)?\s*[,.!?，。！？]\s*(?:what|which|who|when|where|why|how|is|are|am|was|were|do|does|did|can|could|would|should|must|will|has|have|had)\b.*[?？]\s*$/i,
