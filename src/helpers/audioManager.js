...
const ANSWER_LIKE_TRANSCRIPTION_PATTERNS = [
  ...
  /^(?:sure|yes|yeah|yep|okay|ok|alright|certainly|of\s+course|absolutely)(?:\s*[，,]\s*|\s+)(?:what|when|where|why|who|whom|whose|which|how|is|are|am|do|does|did|can|could|would|should|will|has|have|had)\b/i,
