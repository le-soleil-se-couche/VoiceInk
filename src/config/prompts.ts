...
export function getAnswerLikeRetryPrompt(
  ...
  const instructions = isZh
    ...
    : [
        ...
        "Keep indirect-question stems such as 'let me/us know if/whether ...', 'tell me/us if/whether ...', 'i/we wonder if/whether ...', 'i/we have/I've/we've been wondering if/whether ...', or 'i'm/we're curious if/whether ...' as dictated; do not resolve them into answers.",
...
export function getCleanupOnlyRetryPrompt(
  ...
  const instructions = isZh
    ...
    : [
        ...
        "Preserve indirect-question stems such as 'let me/us know if/whether ...', 'tell me/us if/whether ...', 'i/we wonder if/whether ...', 'i/we have/I've/we've been wondering if/whether ...', or 'i'm/we're curious if/whether ...'; do not rewrite them into direct answers.",
