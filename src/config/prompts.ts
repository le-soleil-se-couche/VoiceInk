...
export function getAnswerLikeRetryPrompt(
  ...
  const instructions = isZh
    ...
    : [
        ...
        "Keep indirect-question stems such as 'let me/us know if/whether ...', 'tell me/us if/whether ...', or 'i wonder if/whether ...' as dictated; do not resolve them into answers.",
...
export function getCleanupOnlyRetryPrompt(
  ...
  const instructions = isZh
    ...
    : [
        ...
        "Preserve indirect-question stems such as 'let me/us know if/whether ...', 'tell me/us if/whether ...', or 'i wonder if/whether ...'; do not rewrite them into direct answers.",
