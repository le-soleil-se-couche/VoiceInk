...
export function getAnswerLikeRetryPrompt(
  ...
  const instructions = isZh
    ...
    : [
        ...
        "Do not add assistant wrappers, standalone acknowledgement prefaces (for example, 'Sure.', 'Yes.', 'No.', 'Definitely.', 'Totally.', 'Exactly.', 'Precisely.', 'Indeed.', 'Agreed.', 'Correct.', 'That's right.', 'That is right.', 'That's correct.', 'That is correct.', 'You're right.', 'You are right.', 'You're correct.', 'You are correct.', 'You're absolutely right.', 'You are absolutely right.', 'You're totally right.', 'You are totally right.', or '你说得对。'), question-compliment prefaces (for example, 'Great question.', 'Good question.', or 'That's a great question.'), advisory lead-ins (for example, 'I recommend ...', 'I strongly recommend ...', 'My recommendation is ...', 'My recommendation: ...', 'I'd suggest ...', or '建议...'), answer-statement prefaces (for example, 'The answer is ...', 'The short answer is ...', or '答案是...'), bare acknowledgement lead-ins (for example, 'Yes we should ...', 'Definitely we should ...', 'Totally we should ...', 'Exactly we should ...', 'Precisely we should ...', 'Indeed we should ...', 'Agreed we should ...', 'Correct we should ...', 'That's right we should ...', 'That is right we should ...', 'That's correct we should ...', 'That is correct we should ...', 'You're right we should ...', 'You are right we should ...', 'You're correct we should ...', 'You are correct we should ...', 'You're absolutely right we should ...', 'You are absolutely right we should ...', 'You're totally right we should ...', 'You are totally right we should ...', or '你说得对我们...'), or label prefixes such as 'Answer:', 'Final answer:', 'Here's the polished version', 'Rewritten text:', or 'Cleaned transcript:'.",
      ];
...
export function getCleanupOnlyRetryPrompt(
  ...
  const instructions = isZh
    ...
    : [
        ...
        "Do not add assistant wrappers, standalone acknowledgement prefaces (for example, 'Sure.', 'Yes.', 'No.', 'Definitely.', 'Totally.', 'Exactly.', 'Precisely.', 'Indeed.', 'Agreed.', 'Correct.', 'That's right.', 'That is right.', 'That's correct.', 'That is correct.', 'You're right.', 'You are right.', 'You're correct.', 'You are correct.', 'You're absolutely right.', 'You are absolutely right.', 'You're totally right.', 'You are totally right.', or '你说得对。'), question-compliment prefaces (for example, 'Great question.', 'Good question.', or 'That's a great question.'), advisory lead-ins (for example, 'I recommend ...', 'I strongly recommend ...', 'My recommendation is ...', 'My recommendation: ...', 'I'd suggest ...', or '建议...'), answer-statement prefaces (for example, 'The answer is ...', 'The short answer is ...', or '答案是...'), bare acknowledgement lead-ins (for example, 'Yes we should ...', 'Definitely we should ...', 'Totally we should ...', 'Exactly we should ...', 'Precisely we should ...', 'Indeed we should ...', 'Agreed we should ...', 'Correct we should ...', 'That's right we should ...', 'That is right we should ...', 'That's correct we should ...', 'That is correct we should ...', 'You're right we should ...', 'You are right we should ...', 'You're correct we should ...', 'You are correct we should ...', 'You're absolutely right we should ...', 'You are absolutely right we should ...', 'You're totally right we should ...', 'You are totally right we should ...', or '你说得对我们...'), or label prefixes such as 'Sure', 'Of course', 'You can', 'Answer:', 'Final answer:', 'Here's the polished version', 'Rewritten text:', or 'Cleaned transcript:'.",
