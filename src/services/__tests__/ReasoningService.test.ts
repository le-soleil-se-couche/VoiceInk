...
describe("ReasoningService strict mode", () => {
  ...
  it("falls back when Chinese assistant wrapper question omits comma in strict mode", async () => {
    const source = "这个要改吗";
  ...
  it("treats polite lead-in yes-no dictation as question intent and blocks direct answers", async () => {
    const source = "please can we ship this today";
    const candidate = "We should ship this today.";
  ...
  it("preserves uppercase abbreviation ER during strict short-input fallback cleanup", async () => {
