...
describe("ReasoningService strict mode", () => {
  ...
  it("falls back when a subjectless indirect English question is rewritten into an answer", () => {
    const source = "need to know if this needs a migration";
    const candidate = "This needs a migration.";
  ...
  it("falls back when a direct question is reframed into a can-you-tell-me request", () => {
    const source = "what time is the deploy";
    const candidate = "Can you tell me what time the deploy is?";
  ...
  it("falls back when a direct question is reframed into an imperative tell-me request", () => {
    const source = "what time is the deploy";
    const candidate = "Please tell me what time the deploy is.";
