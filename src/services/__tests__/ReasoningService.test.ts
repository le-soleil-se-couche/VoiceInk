...
describe("ReasoningService strict mode", () => {
  ...
  it("falls back when a question dictation is preserved and then answered inline without punctuation", async () => {
    const source = "what is the capital of france";
    const candidate = "What is the capital of France the capital of France is Paris.";
  ...
  it("treats check-whether dictation as question intent and blocks direct answers", async () => {
    const source = "check whether we should ship this today";
    const candidate = "We should ship this today.";
  ...
  it("treats confirm-whether dictation as question intent and blocks direct answers", async () => {
    const source = "please confirm whether we should ship this today";
    const candidate = "We should ship this today.";
  ...
  it("treats i-was-wondering-if dictation as question intent and blocks direct answers", async () => {
    const source = "i was wondering if we should ship this today";
    const candidate = "We should ship this today.";
  ...
  it("treats figure-out-if dictation as question intent and blocks direct answers", async () => {
    const source = "i need to figure out if we should ship this today";
    const candidate = "We should ship this today.";
