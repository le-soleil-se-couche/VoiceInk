...
describe("ReasoningService strict mode", () => {
  ...
  it("falls back when a terse answer is prepended before the preserved English question", async () => {
    const source = "what is the capital of france";
    const candidate = "Paris. What is the capital of France?";
  ...
  it("falls back when assistant-style wrapper is split into a leading sentence before the question", async () => {
    const source = "what is the capital of france";
    const candidate = "Sure. What is the capital of France?";
  ...
  it("falls back when an English assistant wrapper question omits the separator punctuation", async () => {
    const source = "what is the capital of france";
    const candidate = "Sure what is the capital of France?";
  ...
  it("falls back when a Chinese assistant wrapper question omits the separator punctuation", async () => {
    const source = "这个要改吗";
  ...
  it("falls back when a Chinese assistant wrapper is split into a leading sentence before the question", async () => {
    const source = "这个要改吗";
    const candidate = "好的。这个要改吗？";
  ...
  it("treats confirm-whether dictation as question intent and blocks direct answers", async () => {
    const source = "confirm whether this is ready to ship today";
    const candidate = "This is ready to ship today.";
  ...
  it("treats please-confirm-if dictation as question intent and blocks direct answers", async () => {
    const source = "please confirm if this will run locally";
    const candidate = "This will run locally.";
  ...
  it("treats check-if dictation as question intent and blocks direct answers", async () => {
    const source = "check if this will run locally";
    const candidate = "This will run locally.";
  ...
  it("treats help-me-decide-whether dictation as question intent and blocks direct answers", async () => {
    const source = "help me decide whether we should ship this today";
    const candidate = "We should ship this today.";
  ...
  it("treats wondering-whether dictation as question intent and blocks direct answers", async () => {
    const source = "i was wondering whether this is ready to ship";
    const candidate = "This is ready to ship.";
